...
namespace EcomercerWebsite_Fruit.Migrations
{
    ...
    [Migration("20240628133616_FKProductToReview")]
    partial class FKProductToReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcomercerWebsite_Fruit.Models.BillInformation", b =>
                {
                    ...
                    b.Property<int>("NumberBuyPerProduct")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcomercerWebsite_Fruit.Models.Product", b =>
                {
                    ...
                    b.Property<int>("NumberProductSell")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcomercerWebsite_Fruit.Models.Review", b =>
                {
                    b.Property<string>("ReviewID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("EcomercerWebsite_Fruit.Models.Review", b =>
                {
                    b.HasOne("EcomercerWebsite_Fruit.Models.Customer", "customer")
                        .WithMany("Reviews")
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
